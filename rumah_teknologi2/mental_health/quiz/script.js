...
var progressno = document.getElementById("progress-number");
...
function progressNoApaAja() {
  var quizHTML = '<div class="progressNumber">Progress ' + currentQuestion + ' / ' + quiz.length + ' done</div>';
  quizContainer.innerHTML = quizHTML;
  submitButton.style.display = "none";
  restartButton.style.display = "block";
}
